 ...
 * @param {String[]} [options.reporters=[]]
...
function _isSmallerAfterCompression(rawFile, compressedFile, options) {
    return compressedFile.remove()
        .then(function () {
            return (rawFile.size - compressedFile.size) * 100 / rawFile.size > options.tolerance;
        });
}
...
module.exports = {
    ...
    optim: function (rawFile, algorithms, options) {
        return _imageOptim(rawFile, algorithms, function (prev, next) {
            return prev.then(function (res) {
                return next(rawFile, _initCompressedFile(rawFile.name, options._tmpDir))
    ...
    lint: function (rawFile, algorithms, options) {
        return _imageOptim(rawFile, algorithms, function (prev, next) {
            return prev.then(function (res) {
                return res || next(rawFile, _initCompressedFile(rawFile.name, options._tmpDir))
                    .then(function (compressed) {
